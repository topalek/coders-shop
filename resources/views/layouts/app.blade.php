                        ...
                        <ul>
                            <li class="menu-item">
                                <a title="Hotline: (+123) 456 789" href="#">
                                    <span class="icon label-before fa fa-mobile"></span>Hotline: (+123) 456 789</a>
                            </li>
                        </ul>
                    </div>
                    <div class="topbar-menu right-menu">
                        <ul>
                            ...
                            <li class="menu-item lang-menu menu-item-has-children parent">
                                <a title="English" href="#">
                                    <span class="img label-before">
                                        <img src="{{asset("assets/images/lang-en.png")}}" alt="lang-en"></span>
                                    English
                            ...
                            <li class="menu-item menu-item-has-children parent">
                                <a title="Dollar (USD)" href="#">Dollar (USD)
                                    <i class="fa fa-angle-down" aria-hidden="true"></i>
                                </a>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#" class="link-to-item" title="our application on apple store">
                                                <figure>
                                                    <img src="{{asset("assets/images/brands/apple-store.png")}}"
                                        ...
                                        <li>
                                            <a href="#" class="link-to-item"
                                               title="our application on google play store">
                                                <figure>
                                                    <img src="{{asset("assets/images/brands/google-play-store.png")}}"
